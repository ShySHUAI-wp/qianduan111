...
const content = `import { useState, useRef, useEffect, CSSProperties } from 'react';
import {
  Button, Form, Input, Modal, Select, Steps, Typography, message,
} from 'antd';
import {
  UsbOutlined, CheckCircleOutlined, PlayCircleOutlined, StopOutlined,
  SettingOutlined,
